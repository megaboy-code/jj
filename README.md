...
<head>
  ...
  <title>🧠 MEGA FLOWZ - Professional Trading Dashboard</title>
...
<body>
  <div class="tabs-container">
    <div class="tabs-header">
      <button class="tab active" onclick="switchTab('pyramid')">🏔️ Pyramid</button>
    ...
    <div id="pyramid-tab" class="tab-content active">
      <div class="header">
        <h1>🧠 MEGA FLOWZ - Professional Trading Dashboard</h1>
        ...
        <div class="pyramid-style-selector">
          <div class="style-controls">
            ...
            <select id="pairsSelect" class="style-dropdown" onchange="changePair(this.value)">
              ...
              <option value="ADA/USD">🟥 Cardano/USD</option>
              <option value="SOL/USD">🟦 Solana/USD</option>
              <option value="XRP/USD">⚡ Ripple/USD</option>
              <option value="DOT/USD">🔴 Polkadot/USD</option>
              <option value="DOGE/USD">🐶 Dogecoin/USD</option>
              <option value="LTC/USD">🔶 Litecoin/USD</option>
              <option value="BNB/USD">💎 Binance Coin/USD</option>
              <option value="MATIC/USD">🔷 Polygon/USD</option>
              
              <!-- Commodities -->
              <option value="XAU/USD">🥇 Gold/USD</option>
              <option value="XAG/USD">🥈 Silver/USD</option>
              <option value="XPT/USD">🔧 Platinum/USD</option>
              <option value="XPD/USD">⚡ Palladium/USD</option>
            ...
            <select id="pyramidStyleSelect" class="style-dropdown" onchange="changePyramidStyle(this.value)">
              <option value="scalper">⚡ Scalper (M15→M5→M1)</option>
              <option value="intraday">📈 Intraday (H1→M15→M5→M1)</option>
              <option value="swing">🔄 Swing (H4→H1→M15→M5→M1)</option>
              <option value="daily" selected>📅 Daily (D1→H4→H1→M15→M5→M1)</option>
            </select>
          </div>
        </div>
        
        <div class="info" id="status">🔄 Loading market data...</div>
      </div>
      
      <div class="controls">
        <button class="size-btn" onclick="setPyramidSize('small')">📱 Compact</button>
        <button class="size-btn active" onclick="setPyramidSize('medium')">📊 Standard</button>
        <button class="size-btn" onclick="setPyramidSize('large')">🖥️ Detailed</button>
      </div>
    ...
    <div id="chart-tab" class="tab-content">
      <div class="chart-container">
        <div class="chart-controls">
          ...
          <!-- Chart Controls -->
          <button class="control-btn" id="crosshairBtn" onclick="toggleCrosshair()">⊕</button>
          <button class="control-btn" onclick="downloadChart()">💾 Save</button>
        ...
        <div class="chart-area">
          ...
          <div class="indicators-panel collapsed" id="indicatorsPanel">
            <div class="panel-header">
              <span class="panel-emoji" onclick="toggleIndicatorsPanel()">📊</span>
